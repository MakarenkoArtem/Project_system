...
def test(table_id):  # форма для добавления теста
    ...
    # return redirect('/')
    return render_template('test.html', columns={1:"в ожидании", 2:'в процессе', 3:'завершено'}, actions={1:["создание дизайна", 1], 2:['создание бд',1], 3:['создание запросов',1]})


@app.route('/test1', methods=['GET', 'POST'])
def test1():  # форма для добавления теста
    # return redirect('/')
    return render_template('test1.html', columns={1:"в ожидании", 2:'в процессе', 3:'завершено'}, actions=[{1:"создание дизайна", 2:'создание бд', 3:'создание запросов'}, {}, {}])
